...
const ButtonThemeToggle = () => {
    ...
    return (
        <button data-tooltip-target="tooltip-dark" id="theme-toggle" onClick={() => toggleTheme(!isDarkMode)} className="text-gray-300 bg-gray-800 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
            {isDarkMode ? (
