...
export default function AddProducts({auth, locations, brands, categories}) {
                ...
                <div className='m-5 borde-2 border-indigo-500/50 p-3'>
                    ...
                    <div className="mt-6 border-t border-gray-100 ">
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <select defaultValue={-1} onChange={e => setData('code_city', e.target.value)} id="underline_select" className="block py-2.5 px-0 w-auto text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-white dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <dd className="mt-1 w-full text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 sm:gap-4">
                            <label for="underline_select" className="sr-only">Underline select</label>
                            <select  defaultValue={-1} onChange={e => setData('code_category', e.target.value)} id="underline_select" className="block py-2.5 px-0 w-auto text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-white dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <dd className="mt-1 w-full text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 sm:gap-4">
                            <label for="underline_select" className="sr-only">Underline select</label>
                            <select  defaultValue={-1}  onChange={e => setData('code_brand', e.target.value)} id="underline_select" className="block py-2.5 px-0 w-auto text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-white dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <dd className="mt-1 w-full text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 sm:gap-4">
                               <textarea className='border-none w-10/12 bg-gray-100 dark:text-white dark:bg-gray-400'
                                    ...
                                    defaultValue={'Descreva aqui o detalhes do produto!'}
                                >
                               </textarea>
                            </dd>
                        </div>
